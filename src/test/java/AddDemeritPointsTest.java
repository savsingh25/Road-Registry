...
public class AddDemeritPointsTest {
    ...
    public void testValidUnder21Suspended() {
        Person p = new Person("user1", "15-11-2006");
    ...
    public void testValidOver21NotSuspended() {
        Person p = new Person("user2", "15-11-1990");
    ...
    public void testInvalidDateFormat() {
        Person p = new Person("user3", "15-11-1990");
    ...
    public void testInvalidPointValue() {
        Person p = new Person("user4", "15-11-1990");
    ...
    public void testSuspensionOver21() {
        Person p = new Person("user5", "15-11-1990");
